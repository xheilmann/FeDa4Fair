...
def create_benchmarks():
    ...
    # Mild: Mitigate + some injection
    # Medium: Slight mitigation or slight injection
    # Strong: High injection
                ...
                "configs": [
                    {
                        ...
                        "value": 1, # Targeting females to increase disparity
