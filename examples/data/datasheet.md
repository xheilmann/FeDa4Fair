# Datasheet for dataset ACSIncomeFeDa4Fair2025-12-29
...
* The present dataset was obtained with FeDa4Fair, commit id 5468f9c1d9528f1f0a364c2a43d6f8e264588e5e and remote https://github.com/xheilmann/FeDa4Fair.git for the purpose of further testing.
...
The data is partially anonymized. This dataset in particular includes data from household in the year 2018 with horizon 1-Year.

### How many instances are there in total (of each type, if appropriate)?
The present dataset has 20914.
...
The data column names are as follows: ["AGEP", "COW", "SCHL", "MAR", "OCCP", "POBP", "RELP", "WKHP", "SEX", "RAC1P", "PINCP"]. 
...
We refer the reader to the ACS PUMS documentation for the year 2018 with horizon 1-Year for a human-readable meaning of these numerical encodings.
...
Please note that this information might differ to the actual microdata sample employed to obtain the present dataset, which is from 2018 with horizon 1-Year.
...
This dataset refers to individuals living in the U.S. in the year 2018 with horizon 1-Year.
...
This dataset is maintained and hosted by its authors: 
