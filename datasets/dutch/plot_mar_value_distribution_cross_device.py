...
def run_evaluation_and_plot():
    num_clients = 150 # Cross-device
    output_dir = Path("./cross_device_value/plots")
    ...
    for model_name, model in models.items():
        print(f"Evaluating Model Fairness for Marital_status using {model_name} (Cross-Device)...")
