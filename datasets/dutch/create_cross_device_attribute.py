...
def create_benchmarks():
    ...
    for level_name, config in levels.items():
        ...
        # For cross-device, we evaluate on the full partition data as fl_setting renames to 'train'
        # but the evaluator uses fds.load_partition internally if fds is passed.
